...
# Motif Release 1.2
#
#   $RCSfile: Makefile,v $ $Revision: 1.1 $ $Date: 1994/05/24 21:29:45 $
...
install:: CmapT
	...
	$(INSTALL) -c $(INSTPGMFLAGS)  CmapT $(DESTDIR)$(BINDIR)

install.man:: CmapT.man
	@if [ -d $(DESTDIR)$(MANDIR) ]; then set +x; \
	else (set -x; $(MKDIRHIER) $(DESTDIR)$(MANDIR)); fi
	$(INSTALL) -c $(INSTMANFLAGS) CmapT.man $(DESTDIR)$(MANDIR)/CmapT.$(MANSUFFIX)
